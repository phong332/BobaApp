...
public class ResizeQuadEffectController : MonoBehaviour
{
    ...
    public bool isHorizontalScreen;
    private void Start()
    ...
    public void RebuildRenderTexturesAll()
    {
        ...
        {
            RenderTexture BackgroundRT = new RenderTexture(currentWidth, currentHeight, 24, RenderTextureFormat.ARGB32, RenderTextureReadWrite.Default);
        ...
        RenderTexture EffectRT = new RenderTexture(currentWidth, currentHeight, 24, RenderTextureFormat.ARGB32, RenderTextureReadWrite.Default);
